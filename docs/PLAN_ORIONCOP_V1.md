...
> **Trazabilidad:** `OrionCopIU/My Project/AssemblyInfo.vb` define `AssemblyVersion("17.39.452.1452")` y `OrionCopIU/mOrionCopIU.vb` toma `My.Application.Info.Version.ToString`.
...
4. La línea base operativa actual documentada para el módulo ejecutable es `v17.39.452.1452`.
...
## 7. Línea base de release

La versión actual a la que se refiere este plan es `v17.39.452.1452`.

Se utiliza como la referencia técnica de la aplicación principal y como punto de partida para la trazabilidad de cambios y releases del repositorio.

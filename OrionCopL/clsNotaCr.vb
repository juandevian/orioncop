...
#Region "Definiciones"
    ...
    Private MdecDsctoCapAplicado As Decimal = 0D
    Private MdecDsctoIntAplicado As Decimal = 0D
    Private MdecDsctoIvaAplicado As Decimal = 0D
    Private MdecDsctoPorValor As Decimal = 0
    Private MDecValorCrMaxCap As Decimal = -1
    Private MdecValorCrMaxInt As Decimal = -1
    Private MdecValorCrMaxIva As Decimal = -1
#End Region
...
#Region "Propiedades Prop"
    ...
    Friend ReadOnly Property ObjIdModoNotaCrByt As New ClsIdModoNotaCrByt(Me)
    ...
    Friend Overrides ReadOnly Property ColPropiedades As Collection
        Get
            If HcolPropiedades.Count = 0 Then
                ...
                HcolPropiedades.Add(ObjIdModoNotaCrByt)
        ...
        Get
            If IsNothing(MobjPredioAgrNCr) Then
                If Not String.IsNullOrEmpty(ObjIdPredioAgrupador_NotaCrStr.ToString()) AndAlso
                        ObjIdPredioAgrupador_NotaCrStr.ToString <> GCSTRSINPA Then
...
#Region "Procedimientos y funciones invalidantes"
    Protected Overrides Sub SVacie()
        ...
        EnuTipoDsctoPorValor = EnuTipoDescuento.None
        MdecDsctoPorValor = 0
        MDecValorCrMaxCap = -1
        MdecValorCrMaxInt = -1
        MdecValorCrMaxIva = -1
        MdecDsctoCapAplicado = 0
        MdecDsctoIntAplicado = 0
        MdecDsctoIvaAplicado = 0
    End Sub
...
#Region "Procedimientos del objeto"
    ...
    Private Sub SActualiceFacturas()
        Dim larlFacturas As New ArrayList, lstrPrefFact As String, lentIdFact As Integer,
                lstrNroFac As String
        ...
        For Each lobjItemNotaCr As ClsItemNotaCr In ColItemsNotaCr
            ...
            lstrNroFac = lstrPrefFact & "," & lentIdFact.ToString
            If Not larlFacturas.Contains(lstrNroFac) Then
                lobjValorLlave = {GshrIdCarpeta, GshrIdCentroUtil, lstrPrefFact, lentIdFact}
                larlFacturas.Add(lstrNroFac)
                lobjFactura.SAbra(lobjValorLlave)
                SActualiceFactura(lobjFactura)
            End If
        Next
    End Sub

    Private Sub SActualiceFactura(aobjFactura As ClsFactura)
        ...
        If EnuEstadoActualizacion = EnuEstadoObjetoDef.EnuCreando Then
            For Each lobjItemNotaCr As ClsItemNotaCr In McolItemsNotaCr
                If lstrPrefFact = lobjItemNotaCr.ObjPrefijoFact_ItemNotaCrStr.ObjValorPro AndAlso
                        lentIdFact = lobjItemNotaCr.ObjIdFactura_ItemNotaCrEnt.ObjValorPro Then
                    ...
                    End If
                    aobjFactura.SApliqueNotaCr(lobjItemNotaCr)
                End If
            Next
    ...
    Friend Function FblnEsValidaFecha(adtmFechaNotaCr As Date,
            aobjFactura As ClsFactura) As Boolean
        Dim lblnEsValida = True
        McolItemsNotaCr = ColItemsNotaCr
        For Each lobjItemNotaCr As ClsItemNotaCr In McolItemsNotaCr
            lblnEsValida = lobjItemNotaCr.FblnEsValidaFechaNotaCr(adtmFechaNotaCr, aobjFactura)
    ...
    Friend Function FdecBaseGrabable(aobjFacturaAnulada As ClsFactura) As Decimal
        ...
        If ObjIdTipoNotaCrByt.ObjValorPro = EnuTipoNotaCrDef.EnuAnulaFac Then
            For Each lobjItemFac As ClsItemFactura In aobjFacturaAnulada.ColItemsFactura
                ldecBaseGravable += lobjItemFac.DecBaseIvaServicio
            Next
        End If
    ...
    Friend Function FdtbNotasUltimoMes() As DataTable
        ...
        Dim lstrCampSelPri As String() = {ClsFecha_NotaCrDtm.SstrNombreCampoBd,
                ClsPrefijo_NotaCrStr.SstrNombreCampoBd, ClsIdNotaCrEnt.SstrNombreCampoBd,
                ClsIdPredioAgrupador_NotaCrStr.SstrNombreCampoBd,
                ClsIdCliente_NotaCrDbl.SstrNombreCampoBd, ClsValor_NotaCrDec.SstrNombreCampoBd}
        ...
        Dim lstrFiltro = ClsOrionCop.StrFiltroUbicacion_Pri & " AND " &
                ClsFecha_NotaCrDtm.SstrNombreCampoBd & " BETWEEN " & lstrFechaIni & " AND " &
                lstrFechaFin
        Dim lstrOrden As String(,) = {{ClsFecha_NotaCrDtm.SstrNombreCampoBd, "DESC"},
...
#Region "Manejo descuentos por valor"
    Friend Property EnuTipoDsctoPorValor As EnuTipoDescuento = EnuTipoDescuento.None
    Friend Sub SInicialiceDeudasValor()
        MDecValorCrMaxCap = -1
        MdecValorCrMaxInt = -1
        MdecValorCrMaxIva = -1
    End Sub
    ...
    Friend ReadOnly Property DecValorCrMaxSer As Decimal
        Get
            If MDecValorCrMaxCap = -1 Then
                MDecValorCrMaxCap = FdecValorCrMaxSer(MdecValorCrMaxInt, MdecValorCrMaxIva)
            End If
    ...
    Friend ReadOnly Property DecValorCrMaxInt As Decimal
        Get
            If MdecValorCrMaxInt = -1 Then
                MdecValorCrMaxInt = FdecValorCrMaxSer(MdecValorCrMaxInt, MdecValorCrMaxIva)
            End If
    ...
    Friend ReadOnly Property DecValorCrMaxIva As Decimal
        Get
            If MdecValorCrMaxIva = -1 Then
                MDecValorCrMaxCap = FdecValorCrMaxSer(MdecValorCrMaxInt, MdecValorCrMaxIva)
            End If
            Return MdecValorCrMaxIva
        End Get
    End Property

    Friend ReadOnly Property DecDsctoCapAplicado
        Get
            Return MdecDsctoCapAplicado
        End Get
    End Property

    Friend ReadOnly Property DecDsctoIntAplicado
        Get
            Return MdecDsctoIntAplicado
        End Get
    End Property

    Friend ReadOnly Property DecDsctoIvaAplicado
        Get
            Return MdecDsctoIvaAplicado
        End Get
    End Property

    Private Function FdecValorCrMaxSer(ByRef adecValorCrMaxInt As Decimal,
            ByRef adecValorCrMaxIva As Decimal) As Decimal
        Dim ldecValorCrMaxSer = 0D, ldecValorCrMaxInt = 0D, ldecValorCrMaxIva = 0D
        ...
        For Each ldrwFactViva As DataRow In ldtbFactVivas.Rows
            ...
            lobjFactura.SAbra(lobjValorLlave)
            ldecValorCrMaxSer += lobjFactura.FdecDeudaServicios()
            ldecValorCrMaxInt += lobjFactura.FdecDeudaIntServicios()
            ldecValorCrMaxIva += lobjFactura.FdecDeudaIvaTotal()
        Next
        adecValorCrMaxInt = ldecValorCrMaxInt
        adecValorCrMaxIva = ldecValorCrMaxIva
        Return ldecValorCrMaxSer
    End Function
    ...
    Private Function FdtbFacturasVivas() As DataTable
        ...
        Dim lstrFiltro = ClsOrionCop.StrFiltroUbicacion & " AND " &
                ...
                ObjIdCliente_NotaCrDbl.ObjValorPro & " AND " &
    ...
    Friend Function FblnTipoDsctoValido(ByRef astrMens As String)
        Dim lblnEsValido As Boolean
        Select Case EnuTipoDsctoPorValor
            Case EnuTipoDescuento.EnuDsctoCapital
                lblnEsValido = DecValorCrMaxSer > 0
                If Not lblnEsValido Then
                    astrMens = "No hay deuda de capital para aplicar el descuento!"
                Else
                    lblnEsValido = DecDsctoCapAplicado = 0
                    If Not lblnEsValido Then
                        astrMens = "No es posible aplicar un tipo de descuento mas de una vez."
                    End If
                End If
            Case EnuTipoDescuento.EnuDsctoIntMora
                lblnEsValido = DecValorCrMaxInt > 0
                If Not lblnEsValido Then
                    astrMens = "No hay deuda de intereses para aplicar el descuento!"
                Else
                    lblnEsValido = DecDsctoIntAplicado = 0
                    If Not lblnEsValido Then
                        astrMens = "No es posible aplicar un tipo de descuento mas de una vez."
                    End If
                End If
            Case EnuTipoDescuento.EnuCancelaIva
                ...
                If Not lblnEsValido Then
                    astrMens = "No hay deuda de IVA para aplicar el descuento!"
                Else
                    lblnEsValido = DecDsctoIvaAplicado = 0
                    If Not lblnEsValido Then
                        astrMens = "No es posible aplicar un tipo de descuento mas de una vez."
                    End If
                End If
            Case EnuTipoDescuento.EnuReteCree, EnuTipoDescuento.EnuReteFuente,
                    EnuTipoDescuento.EnuReteCree, EnuTipoDescuento.EnuReteIca,
                    EnuTipoDescuento.EnuReteIva
                astrMens = "El tipo de descuento no es válido para ser aplicado por valor."
                lblnEsValido = False
        End Select
        Return lblnEsValido
    End Function

    Friend Function FblnValorDsctoValido(ByRef astrMens As String)
        Dim lblnEsValido As Boolean
        If MdecDsctoPorValor > 0 Then
            Select Case EnuTipoDsctoPorValor
                Case EnuTipoDescuento.EnuDsctoCapital
                    lblnEsValido = MdecDsctoPorValor <= DecValorCrMaxSer
                Case EnuTipoDescuento.EnuDsctoIntMora
                    lblnEsValido = MdecDsctoPorValor <= DecValorCrMaxInt
                Case EnuTipoDescuento.EnuCancelaIva
                    lblnEsValido = MdecDsctoPorValor <= DecValorCrMaxIva
            End Select
            If Not lblnEsValido Then
                astrMens = "El valor del descuento supera la deuda!"
            End If
        Else
            lblnEsValido = False
            astrMens = "El valor del descuento debe ser mayor a cero!"
        End If
        Return lblnEsValido
    End Function
    ...
    Friend Sub SApliqueDescuentoValor()
        ...
        For Each ldrwFactViva As DataRow In ldtbFactVivas.Rows
            ...
            If ldecValorPorAplicar > 0 Then
                ...
                Select Case EnuTipoDsctoPorValor
                    Case EnuTipoDescuento.EnuDsctoCapital
                        SApliqueDsctoCapitalFac(lobjFact, ldecValorPorAplicar,
                                ldecValorAplicado)
                        MdecDsctoCapAplicado += ldecValorAplicado
                    Case EnuTipoDescuento.EnuDsctoIntMora
                        SApliqueDsctoMoraFac(lobjFact, ldecValorPorAplicar, ldecValorAplicado)
                        MdecDsctoIntAplicado += ldecValorAplicado
                    Case EnuTipoDescuento.EnuCancelaIva
                        SApliqueDsctoIVA(lobjFact, ldecValorPorAplicar, ldecValorAplicado)
                        MdecDsctoIvaAplicado += ldecValorAplicado
                End Select
    ...
    Private Sub SApliqueDsctoCapitalFac(aobjFac As ClsFactura, adecValorPorAplicar As Decimal,
        ...
        Dim ldecValorAplicado As Decimal, ldecDeudaServicio As Decimal
        For Each lobjItemFac As ClsItemFactura In aobjFac.ColItemsFactura
            If adecValorPorAplicar > 0 Then
                ldecDeudaServicio = lobjItemFac.DecDeudaSer
                If ldecDeudaServicio > 0 Then
                    If adecValorPorAplicar >= ldecDeudaServicio Then
                        ldecValorAplicado = ldecDeudaServicio
                    Else
                        ldecValorAplicado = adecValorPorAplicar
                    End If
                    Dim ldecBase = 0D
                    Dim ldblTasa = ClsOrionCop.FdblTasaDscto(aobjFac.StrNumeroFactura,
                        lobjItemFac.ObjIdItemFacturaShr.ObjValorPro,
                        EnuTipoDescuento.EnuDsctoCapital, ldecValorAplicado, ldecBase)
                    ...
                    lobjItemNotaCr.ObjIdTipoDscto_ItemNotaCrByt.ObjValorPro =
                            EnuTipoDescuento.EnuDsctoCapital
                    ...
                    SAdicioneNuevoItem(lobjItemNotaCr, aobjFac)
    ...
    Private Sub SApliqueDsctoMoraFac(aobjFac As ClsFactura, adecValorPorAplicar As Decimal,
        ...
        For Each lobjItemFac As ClsItemFactura In aobjFac.ColItemsFactura
            If adecValorPorAplicar > 0 Then
                ldecDeudaMora = lobjItemFac.DecDeudaInt
                If ldecDeudaMora > 0 Then
                    ...
                    Dim ldblTasa = ClsOrionCop.FdblTasaDscto(aobjFac.StrNumeroFactura,
                        lobjItemFac.ObjIdItemFacturaShr.ObjValorPro,
                        EnuTipoDescuento.EnuDsctoIntMora, ldecValorAplicado, ldecBase)
                    Dim lobjItemNotaCr = FobjNewItemNotaCr()
                    lobjItemNotaCr.ObjPrefijoFact_ItemNotaCrStr.ObjValorPro =
                        aobjFac.ObjPrefijo_FactStr.ObjValorPro
                    lobjItemNotaCr.ObjIdFactura_ItemNotaCrEnt.ObjValorPro =
                    ...
                    lobjItemNotaCr.ObjEsReversionIvaBln.ObjValorPro = False
                    lobjItemNotaCr.ObjIdTipoDscto_ItemNotaCrByt.ObjValorPro =
                            EnuTipoDescuento.EnuDsctoIntMora
                    SAdicioneNuevoItem(lobjItemNotaCr, aobjFac)
                    adecValorAplicado += ldecValorAplicado
                    adecValorPorAplicar -= ldecValorAplicado
                End If
    ...
    Private Sub SApliqueDsctoIVA(aobjFac As ClsFactura, adecValorPorAplicar As Decimal,
        ...
        For Each lobjItemFac As ClsItemFactura In aobjFac.ColItemsFactura
            If adecValorPorAplicar > 0 Then
                ' IVA 
                ldecDeudaIVA = lobjItemFac.FdecDeudaIvaTotal
                If ldecDeudaIVA > 0 Then
                    ...
                    Dim ldblTasa = ClsOrionCop.FdblTasaDscto(aobjFac.StrNumeroFactura,
                        lobjItemFac.ObjIdItemFacturaShr.ObjValorPro,
                        EnuTipoDescuento.EnuCancelaIva, ldecValorAplicado, ldecBase)
                    Dim lobjItemNotaCr = FobjNewItemNotaCr()
                    lobjItemNotaCr.ObjPrefijoFact_ItemNotaCrStr.ObjValorPro =
                        aobjFac.ObjPrefijo_FactStr.ObjValorPro
                    lobjItemNotaCr.ObjIdFactura_ItemNotaCrEnt.ObjValorPro =
                    ...
                    lobjItemNotaCr.ObjIdTipoDscto_ItemNotaCrByt.ObjValorPro =
                            EnuTipoDescuento.EnuCancelaIva
                    SAdicioneNuevoItem(lobjItemNotaCr, aobjFac)
                    adecValorAplicado += ldecValorAplicado
                    adecValorPorAplicar -= ldecValorAplicado
                End If
    ...
    Friend Sub SVacieDescuentos()
        McolItemsNotaCr = Nothing
        MdecDsctoPorValor = 0D
        EnuTipoDsctoPorValor = EnuTipoDescuento.None
        MdecDsctoCapAplicado = 0D
        MdecDsctoIntAplicado = 0D
        MdecDsctoIvaAplicado = 0D
        MDecValorCrMaxCap = -1D
        MdecValorCrMaxInt = -1D
        MdecValorCrMaxIva = -1D
    End Sub
#End Region
...
#Region "Procedimientos de Factura"
    Friend Sub SAnuleFactura(aobjFactura As ClsFactura)
        ...
        For Each lobjItemFac As ClsItemFactura In aobjFactura.ColItemsFactura
            Dim ldecValorServicio = lobjItemFac.DecValorServicio()
            Dim ldecIva = lobjItemFac.DecIvaServicio
            If ldecValorServicio > 0 Then
                ...
                With lobjItemNotaCr
                    ...
                    .ObjIdItemFac_ItemNotaCrShr.ObjValorPro =
                            lobjItemFac.ObjIdItemFacturaShr.ObjValorPro
                    .ObjBaseDscto_NotaCrDec.ObjValorPro = ldecValorServicio
                    .ObjTasaDscto_ItemNotaCrDbl.ObjValorPro = 1
                    .ObjIdTipoDscto_ItemNotaCrByt.ObjValorPro = EnuTipoDescuento.EnuDsctoCapital
                    .ObjValor_ItemNotaCrDec.ObjValorPro = ldecValorServicio
                End With
            ...
            If ldecIva > 0 Then
                ...
                With lobjItemNotaCr
                    ...
                    .ObjIdItemFac_ItemNotaCrShr.ObjValorPro =
                            lobjItemFac.ObjIdItemFacturaShr.ObjValorPro
                    .ObjBaseDscto_NotaCrDec.ObjValorPro = ldecIva
                    .ObjTasaDscto_ItemNotaCrDbl.ObjValorPro = 1
                    .ObjIdTipoDscto_ItemNotaCrByt.ObjValorPro = EnuTipoDescuento.EnuCancelaIva
                    .ObjValor_ItemNotaCrDec.ObjValorPro = ldecIva
                End With
                ObjValor_NotaCrDec.ObjValorPro += lobjItemNotaCr.ObjValor_ItemNotaCrDec.ObjValorPro
                ColItemsNotaCr.Add(lobjItemNotaCr)
            End If
            Dim ldecIntMora = lobjItemFac.DecDeudaInt
            Dim ldecIvaInt = lobjItemFac.DecDeudaIvaInt
            If ldecIntMora > 0 Then
                lobjItemNotaCr = FobjNewItemNotaCr()
                With lobjItemNotaCr
                    .ObjEsReversionIvaBln.ObjValorPro = False
                    .ObjPrefijoFact_ItemNotaCrStr.ObjValorPro = lstrPrefFact
                    ...
                    .ObjIdItemFac_ItemNotaCrShr.ObjValorPro = lobjItemFac.ObjIdItemFacturaShr.
                                    ObjValorPro
                    .ObjBaseDscto_NotaCrDec.ObjValorPro = ldecIntMora
                    .ObjTasaDscto_ItemNotaCrDbl.ObjValorPro = 1
                    .ObjIdTipoDscto_ItemNotaCrByt.ObjValorPro = EnuTipoDescuento.
                                EnuDsctoIntMora
                    .ObjValor_ItemNotaCrDec.ObjValorPro = ldecIntMora
                End With
                ObjValor_NotaCrDec.ObjValorPro += lobjItemNotaCr.ObjValor_ItemNotaCrDec.
                            ObjValorPro
                ColItemsNotaCr.Add(lobjItemNotaCr)
                If ldecIvaInt > 0 Then
                    Dim ldecBaseIvaInt = lobjItemFac.FdecBaseIvaIntSer
                    lobjItemNotaCr = FobjNewItemNotaCr()
                    With lobjItemNotaCr
                        .ObjEsReversionIvaBln.ObjValorPro = True
                        .ObjPrefijoFact_ItemNotaCrStr.ObjValorPro = lstrPrefFact
                        ...
                        .ObjIdItemFac_ItemNotaCrShr.ObjValorPro =
                            lobjItemFac.ObjIdItemFacturaShr.ObjValorPro
                        .ObjBaseDscto_NotaCrDec.ObjValorPro = ldecIvaInt
                        .ObjTasaDscto_ItemNotaCrDbl.ObjValorPro = 1
                        .ObjIdTipoDscto_ItemNotaCrByt.ObjValorPro = EnuTipoDescuento.
                                EnuDsctoIntMora
                        .ObjValor_ItemNotaCrDec.ObjValorPro = ldecIvaInt
                    End With
                    ObjValor_NotaCrDec.ObjValorPro += lobjItemNotaCr.ObjValor_ItemNotaCrDec.
                            ObjValorPro
                    ColItemsNotaCr.Add(lobjItemNotaCr)
...
#Region "Manejo Items Nota Cr"
    ...
    Friend Sub SAdicioneNuevoItem(aobjNuevoItemNotaCr As ClsItemNotaCr, aobjFact As ClsFactura)
        Try
            If IsNothing(McolItemsNotaCr) Then
                McolItemsNotaCr = ColItemsNotaCr
            End If
            ...
            ObjFecha_NotaCrDtm.SValideFechaConItems(aobjFact)
        Catch ex As ErrorInesperadoPanDatException
            Throw
        Catch ex As ErrorInesperadoPanLException
            Throw
    ...
    Friend Function FblnExisteNuevoItem(astrPrefFact As String, aentIdFact As Integer,
            ashrIdItemFac As Short, aenuTipoDscto As EnuTipoDescuento) As Boolean
        Dim lstrPrefFact = String.Empty, lentIdFact = 0, lshrIdItemFac = 0S, lblnExiste = False
        Dim lenuTipoDscto = EnuTipoDescuento.None
        For Each lobjItemNotaCr As ClsItemNotaCr In ColItemsNotaCr
            With lobjItemNotaCr
                ...
                If lblnExiste Then
                    lblnExiste = Not (BlnAnulandoFac AndAlso (aenuTipoDscto =
                            EnuTipoDescuento.EnuDsctoCapital OrElse aenuTipoDscto =
                            EnuTipoDescuento.EnuDsctoIntMora))
                End If
    ...
    Friend Function FdecValorDescuento(aenuTipoDescuento As EnuTipoDescuento) As Decimal
        Dim ldecDscto = 0D
        For Each lobjitemNCr As ClsItemNotaCr In ColItemsNotaCr
...
Friend Class ClsFecha_NotaCrDtm
    ...
    End Sub
    Friend Sub SValideFechaConItems(aobjFactura As ClsFactura)
        HblnEsValido = MobjPadre.FblnEsValidaFecha(HobjValorPro, aobjFactura)
    End Sub
    Public Overrides Sub SValide()
...
Friend Class ClsIdTipoNotaCrByt
    ...
    Public Overrides Sub SValide()
        HblnEsValido = ClsPanorama.FblnEsValidoEnumByte(HobjValorNew,
                EnuTipoNotaCrDef.EnuDescuento, EnuTipoNotaCrDef.EnuRetenciones, BlnEsRequerido)
        If HblnEsValido Then
            If MobjPadre.EnuEstadoActualizacion = EnuEstadoObjetoDef.EnuCreando Then
                If HobjValorNew <> EnuTipoNotaCrDef.EnuDescuento Then
                    HblnEsValido = MobjPadre.ObjIdModoNotaCrByt.ObjValorPro =
...
Friend Class ClsIdModoNotaCrByt
    Inherits ClsCBPropiedad
    ...
    Public Overrides Sub SValide()
        HblnEsValido = ClsPanorama.FblnEsValidoEnumByte(HobjValorNew,
                EnuModoNotaCr.EnuPorFactura, EnuModoNotaCr.EnuPorValor, BlnEsRequerido)
    End Sub
    Friend Shared ReadOnly Property SstrNombreCampoBd As String
        Get
            Return MCSTRNOMBRECAMPOBD

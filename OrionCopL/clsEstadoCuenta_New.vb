        ...
        For Each lobjItemFac As ClsItemFactura In aobjFactura.ColItemsFactura
            If lobjItemFac.DecDeuda > 0 Then
                ...
                With lobjFacturaEstado
                    ...
                    .ObjDeudaCap_ItFacEstDec.ObjValorPro = lobjItemFac.FdecDeudaServicioTotal
                    .ObjDeudaIntMes_ItFacEstDec.ObjValorPro = ldecMoraMes
                    .ObjDeudaIntMora_ItFacEstDec.ObjValorPro = lobjItemFac.FdecDeudaIntMora
                    .ObjOrdinal_FacEstadoShr.ObjValorPro = McolFacturasEstado.Count + 1
                End With
                McolFacturasEstado.Add(lobjFacturaEstado)
                ObjDeudaCapitalDec.ObjValorPro += lobjItemFac.FdecDeudaServicioTotal
                ObjDeudaIntMoraDec.ObjValorPro += lobjItemFac.FdecDeudaIntMora
            End If
        Next
    End Sub

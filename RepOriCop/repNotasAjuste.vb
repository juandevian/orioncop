...
Public Class repNotasAjuste
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "OPT.OrionP.RepOriCop.repNotasAjuste.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrepNotasAjuste
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As repNotasAjuste = New repNotasAjuste()
        rpt.Site = Me.Site
        Return rpt
    End Function

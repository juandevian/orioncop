...
Public Class repFacturaEFac
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "OPT.OrionP.RepOriCop.repFacturaEFac.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrepFacturaEFac
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As repFacturaEFac = New repFacturaEFac()
        rpt.Site = Me.Site
        Return rpt
    End Function

...
Public Class repEdadCarGrafico
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "OPT.OrionP.RepOriCop.repEdadCarGrafico.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrepEdadCarGrafico
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As repEdadCarGrafico = New repEdadCarGrafico()
        rpt.Site = Me.Site
        Return rpt
    End Function

...
Public Class repMoviCtaLogo
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "OPT.OrionP.RepOriCop.repMoviCtaLogo.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrepMoviCtaLogo
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As repMoviCtaLogo = New repMoviCtaLogo()
        rpt.Site = Me.Site
        Return rpt
    End Function

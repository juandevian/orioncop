...
Public Class repFacturaLogo
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "OPT.OrionP.RepOriCop.repFacturaLogo.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrepFacturaLogo
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As repFacturaLogo = New repFacturaLogo()
        rpt.Site = Me.Site
        Return rpt
    End Function

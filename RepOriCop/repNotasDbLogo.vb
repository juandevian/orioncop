...
Public Class repNotasDbLogo
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "OPT.OrionP.RepOriCop.repNotasDbLogo.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrepNotasDbLogo
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As repNotasDbLogo = New repNotasDbLogo()
        rpt.Site = Me.Site
        Return rpt
    End Function

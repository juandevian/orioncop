...
Public Class repCtaCobroDet
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "OPT.OrionP.RepOriCop.repCtaCobroDet.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrepCtaCobroDet
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As repCtaCobroDet = New repCtaCobroDet()
        rpt.Site = Me.Site
        Return rpt
    End Function

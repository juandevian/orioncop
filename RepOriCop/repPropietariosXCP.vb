...
Public Class repPropietariosXCP
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "OPT.OrionP.RepOriCop.repPropietariosXCP.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrepPropietariosXCP
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As repPropietariosXCP = New repPropietariosXCP()
        rpt.Site = Me.Site
        Return rpt
    End Function

...
Public Class repResumenMovCont
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "OPT.OrionP.RepOriCop.repResumenMovCont.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrepResumenMovCont
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As repResumenMovCont = New repResumenMovCont()
        rpt.Site = Me.Site
        Return rpt
    End Function

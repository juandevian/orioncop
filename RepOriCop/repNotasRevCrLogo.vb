...
Public Class repNotasRevCrLogo
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "OPT.OrionP.RepOriCop.repNotasRevCrLogo.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrepNotasRevCrLogo
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As repNotasRevCrLogo = New repNotasRevCrLogo()
        rpt.Site = Me.Site
        Return rpt
    End Function

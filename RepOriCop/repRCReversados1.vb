...
Public Class repRCReversados
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "OPT.OrionP.RepOriCop.repRCReversados.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrepRCReversados
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As repRCReversados = New repRCReversados()
        rpt.Site = Me.Site
        Return rpt
    End Function

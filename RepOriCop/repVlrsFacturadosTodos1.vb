...
Public Class repVlrsFacturadosTodos
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "repVlrsFacturadosTodos.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "OPT.OrionP.RepOriCop.repVlrsFacturadosTodos.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrepVlrsFacturadosTodos
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As repVlrsFacturadosTodos = New repVlrsFacturadosTodos()
        rpt.Site = Me.Site
        Return rpt
    End Function

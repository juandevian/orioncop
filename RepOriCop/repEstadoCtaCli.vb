...
Public Class repEstadoCtaCli
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "OPT.OrionP.RepOriCop.repEstadoCtaCli.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrepEstadoCtaCli
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As repEstadoCtaCli = New repEstadoCtaCli()
        rpt.Site = Me.Site
        Return rpt
    End Function

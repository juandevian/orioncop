...
Public Class repAntPorPredioAgr
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "OPT.OrionP.RepOriCop.repAntPorPredioAgr.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrepAntPorPredioAgr
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As repAntPorPredioAgr = New repAntPorPredioAgr()
        rpt.Site = Me.Site
        Return rpt
    End Function

...
Public Class repVlrsFacturados
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "OPT.OrionP.RepOriCop.repVlrsFacturados.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrepVlrsFacturados
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As repVlrsFacturados = New repVlrsFacturados()
        rpt.Site = Me.Site
        Return rpt
    End Function

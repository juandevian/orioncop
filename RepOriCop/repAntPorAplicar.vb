...
Public Class repAntPorAplicar
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "OPT.OrionP.RepOriCop.repAntPorAplicar.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrepAntPorAplicar
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As repAntPorAplicar = New repAntPorAplicar()
        rpt.Site = Me.Site
        Return rpt
    End Function

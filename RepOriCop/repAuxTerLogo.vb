...
Public Class repAuxTerLogo
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "OPT.OrionP.RepOriCop.repAuxTerLogo.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrepAuxTerLogo
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As repAuxTerLogo = New repAuxTerLogo()
        rpt.Site = Me.Site
        Return rpt
    End Function

...
Public Class repNotasDevAntLogo
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "OPT.OrionP.RepOriCop.repNotasDevAntLogo.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrepNotasDevAntLogo
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As repNotasDevAntLogo = New repNotasDevAntLogo()
        rpt.Site = Me.Site
        Return rpt
    End Function

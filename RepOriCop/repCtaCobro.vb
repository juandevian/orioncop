...
Public Class repCtaCobro
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "OPT.OrionP.RepOriCop.repCtaCobro.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrepCtaCobro
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As repCtaCobro = New repCtaCobro()
        rpt.Site = Me.Site
        Return rpt
    End Function

...
Public Class repDirClientes
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "OPT.OrionP.RepOriCop.repDirClientes.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrepDirClientes
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As repDirClientes = New repDirClientes()
        rpt.Site = Me.Site
        Return rpt
    End Function

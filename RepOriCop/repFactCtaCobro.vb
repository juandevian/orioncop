...
Public Class repFactCtaCobro
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "OPT.OrionP.RepOriCop.repFactCtaCobro.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrepFactCtaCobro
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As repFactCtaCobro = New repFactCtaCobro()
        rpt.Site = Me.Site
        Return rpt
    End Function

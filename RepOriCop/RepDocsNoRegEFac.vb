...
Public Class RepDocsNoRegEFac
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "OPT.OrionP.RepOriCop.RepDocsNoRegEFac.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRepDocsNoRegEFac
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RepDocsNoRegEFac = New RepDocsNoRegEFac()
        rpt.Site = Me.Site
        Return rpt
    End Function

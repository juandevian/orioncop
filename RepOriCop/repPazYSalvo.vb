...
Public Class repPazYSalvo
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "OPT.OrionP.RepOriCop.repPazYSalvo.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrepPazYSalvo
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As repPazYSalvo = New repPazYSalvo()
        rpt.Site = Me.Site
        Return rpt
    End Function

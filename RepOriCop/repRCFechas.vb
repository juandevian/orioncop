...
Public Class repRCFechas
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "OPT.OrionP.RepOriCop.repRCFechas.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrepRCFechas
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As repRCFechas = New repRCFechas()
        rpt.Site = Me.Site
        Return rpt
    End Function

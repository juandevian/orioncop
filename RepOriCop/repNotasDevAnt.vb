...
Friend Class repNotasDevAnt
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "OPT.OrionP.RepOriCop.repNotasDevAnt.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Friend Class CachedrepNotasDevAnt
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As repNotasDevAnt = New repNotasDevAnt()
        rpt.Site = Me.Site
        Return rpt
    End Function

...
Public Class repMoviAntLogo
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "OPT.OrionP.RepOriCop.repMoviAntLogo.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrepMoviAntLogo
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As repMoviAntLogo = New repMoviAntLogo()
        rpt.Site = Me.Site
        Return rpt
    End Function

...
Public Class repCxCDetPorSer
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "OPT.OrionP.RepOriCop.repCxCDetPorSer.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrepCxCDetPorSer
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As repCxCDetPorSer = New repCxCDetPorSer()
        rpt.Site = Me.Site
        Return rpt
    End Function

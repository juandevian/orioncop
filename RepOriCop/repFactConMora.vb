...
Public Class repFactConMora
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "OPT.OrionP.RepOriCop.repFactConMora.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrepFactConMora
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As repFactConMora = New repFactConMora()
        rpt.Site = Me.Site
        Return rpt
    End Function

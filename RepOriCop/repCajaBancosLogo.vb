...
Public Class repCajaBancosLogo
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "OPT.OrionP.RepOriCop.repCajaBancosLogo.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrepCajaBancosLogo
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As repCajaBancosLogo = New repCajaBancosLogo()
        rpt.Site = Me.Site
        Return rpt
    End Function

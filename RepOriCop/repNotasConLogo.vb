...
Public Class repNotasConLogo
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "OPT.OrionP.RepOriCop.repNotasConLogo.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrepNotasConLogo
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As repNotasConLogo = New repNotasConLogo()
        rpt.Site = Me.Site
        Return rpt
    End Function
